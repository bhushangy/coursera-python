...
conn = sqlite3.connect('emaildb2.sqlite') #create a new db named emaildb
cur = conn.cursor()
...
for line in fh:
    ...
    org    = organl[1]  #SO THERE ARE TWO COLUMNS HERE NAMELY ORG AND COUNTS
    ...
    row = cur.fetchone()[0] #searching for the row with specified email
